...
kubectl create secret generic proxy-secrets --from-literal=WINDOCKS_REQUIRED_USERNAME='user2' --from-literal=WINDOCKS_REQUIRED_PASSWORD='WCC!!tbBEfN1' --from-literal=WINDOCKS_REQUIRED_CONTAINER_SAPASSWORD='yat!834sd'
